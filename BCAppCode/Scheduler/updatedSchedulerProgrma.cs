    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string strCmd = "insert into tsk.tbl_Tasks2 (TaskName, RunAt, ActionKey, ActionStepKey, Status, RowState, LastModAt, LastModBy, SiteCode, WorkDate, Duration, onCompletion, onError, Reload) "
                + "select Name, NextRunTime, ActionKey, 0, 17, 24, GetDate(), 'Brian.Catellier', 'All', Convert(date, NextRunTime), '0', 0, 0, 0 "
                ...
                + "case when ma.DsnSchema + '.' + ma.DsnTbl = 'pats.tbl_SF_PatientPreAdmission' then 'SAMMS-ETL-PPA' "
                + "when ma.SiteCode = 'PHC' then 'PHC ETL' " + " when ma.SiteCode = 'LAB'  and ma.DsnSchema + '.' + ma.DsnTbl in ('pats.tbl_ClientDemo1', 'pats.tbl_ClientDemo2') then 'Samms-LAB' "
                ...
                + "     when ma.DsnSchema + '.' + ma.DsnTbl = 'pats.tbl_UAResults' then 'SAMMS-ETL-UAR' "
                ...
                + ", 'pats.tbl_EandMFormPregnancy', 'pats.tbl_EandMFormMDM', 'pats.tbl_Bills', 'pats.tbl_payerclthistory', 'pats.tbl_Orders'"
                + ", 'pats.tbl_NewAdmissionAssessmentASAMDimension2', 'pats.tbl_NewAdmissionAssessmentASAMDimension4', 'pats.tbl_NewAdmissionAssessmentASAMDimension5') then 'Eastern ETL P1' "
                + "     when ma.TimeZone = 'EST' and ma.DsnSchema + '.' + ma.DsnTbl in ('pats.tbl_claims', 'pats.tbl_claimlineitem', 'pats.tbl_claimlineitemactivity', "
                + " 'pats.tbl_dose_excuse', 'pats.tbl_uaresultdetail', 'pats.tbl_GlobalPayor', 'pats.tbl_PayerClient', 'pats.tbl_feesched', 'pats.tbl_CheckIn'"
                + ", 'pats.tbl_EandMFormPregnancy', 'pats.tbl_EandMFormMDM', 'pats.tbl_Bills', 'pats.tbl_payerclthistory', 'pats.tbl_treatmentlevel'"
                + ", 'pats.tbl_NewAdmissionAssessmentASAMDimension2', 'pats.tbl_NewAdmissionAssessmentASAMDimension4', 'pats.tbl_NewAdmissionAssessmentASAMDimension5') then 'Eastern ETL P2' "
                ...
                + ", 'pats.tbl_EandMFormPregnancy', 'pats.tbl_EandMFormMDM', 'pats.tbl_Bills', 'pats.tbl_Orders'"
                + ", 'pats.tbl_NewAdmissionAssessmentASAMDimension2', 'pats.tbl_NewAdmissionAssessmentASAMDimension4', 'pats.tbl_NewAdmissionAssessmentASAMDimension5') then 'Central ETL P1' "
                + "     when ma.TimeZone = 'CST' and ma.DsnSchema + '.' + ma.DsnTbl in ('pats.tbl_claims', 'pats.tbl_claimlineitem', 'pats.tbl_claimlineitemactivity', "
                + "'pats.tbl_dose_excuse', 'pats.tbl_uaresultdetail', 'pats.tbl_Enrollment', 'pats.tbl_GlobalPayor', 'pats.tbl_PayerClient', 'pats.tbl_feesched', 'pats.tbl_CheckIn'"
                + ", 'pats.tbl_EandMFormPregnancy', 'pats.tbl_EandMFormMDM', 'pats.tbl_Bills', 'pats.tbl_treatmentlevel' "
                + ", 'pats.tbl_NewAdmissionAssessmentASAMDimension2', 'pats.tbl_NewAdmissionAssessmentASAMDimension4', 'pats.tbl_NewAdmissionAssessmentASAMDimension5') then 'Central ETL P2' "
                ...
                + "'pats.tbl_dose_excuse', 'pats.tbl_uaresultdetail', 'pats.tbl_Enrollment', 'pats.tbl_GlobalPayor', 'pats.tbl_PayerClient', 'pats.tbl_FeeSched', 'pats.tbl_EandMFormMDM', 'pats.tbl_payerclthistory'"
                + ", 'pats.tbl_NewAdmissionAssessmentASAMDimension2', 'pats.tbl_NewAdmissionAssessmentASAMDimension4', 'pats.tbl_NewAdmissionAssessmentASAMDimension5') then 'Mountain ETL P1' "
                ...
                + "'pats.tbl_dose_excuse', 'pats.tbl_uaresultdetail', 'pats.tbl_Enrollment', 'pats.tbl_GlobalPayor', 'pats.tbl_PayerClient', 'pats.tbl_FeeSched', 'pats.tbl_EandMFormMDM', 'pats.tbl_payerclthistory'"
                + ", 'pats.tbl_NewAdmissionAssessmentASAMDimension2', 'pats.tbl_NewAdmissionAssessmentASAMDimension4', 'pats.tbl_NewAdmissionAssessmentASAMDimension5') then 'Mountain ETL P2' "
                ...
                + "'pats.tbl_dose_excuse', 'pats.tbl_uaresultdetail', 'pats.tbl_Enrollment', 'pats.tbl_GlobalPayor', 'pats.tbl_PayerClient', 'pats.tbl_FeeSched', 'pats.tbl_EandMFormMDM', 'pats.tbl_payerclthistory'" 
                + ", 'pats.tbl_NewAdmissionAssessmentASAMDimension2', 'pats.tbl_NewAdmissionAssessmentASAMDimension4', 'pats.tbl_NewAdmissionAssessmentASAMDimension5') then 'Pacific ETL P1' "
                ...
                + "'pats.tbl_dose_excuse', 'pats.tbl_uaresultdetail', 'pats.tbl_Enrollment', 'pats.tbl_GlobalPayor', 'pats.tbl_PayerClient', 'pats.tbl_FeeSched', 'pats.tbl_EandMFormMDM', 'pats.tbl_payerclthistory'" 
                + ", 'pats.tbl_NewAdmissionAssessmentASAMDimension2', 'pats.tbl_NewAdmissionAssessmentASAMDimension4', 'pats.tbl_NewAdmissionAssessmentASAMDimension5') then 'Pacific ETL P2' "
