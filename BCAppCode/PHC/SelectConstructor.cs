            ...
            try 
            {
                ...
                switch (st.DsnTbl.ToLower())
                {
                    ...
                    case "tbl_clientdemo2":
                        ...
                        break;
                    case "tbl_bills":
                        x = sd.SaveBills(SrcDt, st.SiteCode, DateTime.Today, true, null).IsResult;
                        break;
                    case "tbl_codes":
                        ...
                        break;
                    case "tbl_checkin":
                        x = sd.SaveCheckIn(SrcDt, st.SiteCode, DateTime.Today, null);
                        break;
                    case "tbl_claims":
                    ...
                    case "tbl_dartssrv":
                        ...
                        break;
                    case "tbl_dose":
                        rcodes = sd.SaveDoses(SrcDt, st.SiteCode, int.Parse(st.WrkYear), null);
                        x = rcodes.IsResult;
                        break;
                    ...
                    case "tbl_pbi3payauth":
                        x = sd.SaveAuths(SrcDt, st.SiteCode, null);
                        break;
                    case "tbl_services":
            ...
            //{
                switch (st.DsnTbl.ToLower())
                {
                    ...
                    case "tbl_clientdemo2":
                        ...
                        break;
                    case "tbl_bills":
                        rCodes = sd.SaveBills(SrcDt, st.SiteCode, pDT, false, null);
                    ...
                    case "tbl_codes":
                        ...
                        break;
                    case "tbl_checkin":
                        rCodes.IsResult = sd.SaveCheckIn(SrcDt, st.SiteCode, pDT, null);
                        break;
                    case "tbl_claims":
                    ...
                    case "tbl_dartssrv":
                        ...
                        break;
                    case "tbl_dose":
                        rCodes = sd.SaveDoses(SrcDt, st.SiteCode, pDT.Year, null);
                        break;
                    case "tbl_dose_excuse":
