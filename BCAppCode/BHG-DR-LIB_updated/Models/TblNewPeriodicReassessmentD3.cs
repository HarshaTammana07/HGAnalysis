...
{
    [Table("Tbl_NewPeriodicReassessmentD3", Schema = "pats")]
    public partial class TblNewPeriodicReassessmentD3
    {
        ...
        public int? ActivePsychiatricSymptoms { get; set; }
        public int? PersistentDisability { get; set; }
