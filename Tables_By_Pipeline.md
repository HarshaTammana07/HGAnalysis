...
| ----------------------------------------- | -------------------------------------------------------------- | ------------------------------- |
|                                           | Pulled via hardcoded PHCSQLVM connection in PHC runner instead |                                 |
| `pats.tbl_BriefAddictionMonitor`          |                                                                |                                 |
| `pats.tbl_clinicalopiatewithdrawalscale`  |                                                                |                                 |
| `pats.tbl_vw3pBillSub`                    |                                                                |                                 |
| `pats.tbl_Cows_V6` (ActionKey=1, Step=23) |                                                                |                                 |
| `ayx.tbl_PreAdmission_V6`                 |                                                                |                                 |
| `pats.tbl_EandMFormMDM`                   |                                                                |                                 |
| `pats.tbl_EandMFormPregnancy`             |                                                                | Same — PHC uses direct PHCSQLVM |
|                                           | Not supported for PHC                                          |                                 |
|                                           | PHC doesn't have SF_COWS table                                 |                                 |
|                                           | PHC uses older pre-admission schema                            |                                 |
|                                           | Not used at PHC                                                |                                 |
|                                           | Not used at PHC                                                |                                 |
